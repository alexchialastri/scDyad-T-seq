...
START_DIR="/home/achialastri/Expanding_CpG_Diad_BulkSL_2i_M_H_Rep1/AbaSI/S_H_M_rep1/Test_AbaDyad"
...
BARCODES="/home/achialastri/perlscripts/CpG_Diad/AbaSI_5hmC_CpGDyad_SingleCell_Barcodes.txt"
...
perl $PERL_DIR/process_sc5hmC_CpGDiad.pl $GENOME $START_DIR/$OUT_NAME3_R1.sam $BARCODES $UMILength

#Extract Overall Maintenance per cell
perl $PERL_DIR/Pullout-scMaintainedCG_ForAbaSI.pl $START_DIR/$OUT_NAME3_R1.faba

#Take Faba Format into a Maintained and Unmaintained CpG txt file with corrected locations
perl $PERL_DIR/AbaSIFabaToCGtxt.pl $START_DIR/$OUT_NAME3_R1.faba
